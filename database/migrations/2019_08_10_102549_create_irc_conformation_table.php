...
class CreateIrcConformationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('irc_confirmation', function (Blueprint $table) {
            $table->bigIncrements('id');
             ...
             $table->string('resignedmembericno');
             $table->string('resignedmemberbankname');
             $table->string('resignedmemberbranchname');
             $table->string('resignedreason');
             $table->string('ircmembershipno');
