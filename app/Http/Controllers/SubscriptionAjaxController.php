...
class SubscriptionAjaxController extends CommonController
{
    ...
    public function getDatewiseMember(Request $request){
        ...
        if($entry_date!=""){
            ...
            $json_data = ['status_data' => $status_data, 'approval_data' => $approval_data, 'month_year_number' => strtotime($dateformat) , 'sundry_amount' => number_format($sundry_amount,2,".",","), 'sundry_count' => $sundry_count, 'total_members_amount' => number_format($total_members_amount,2,".",","), 'total_members_count' => $total_members_count, 'total_match_members_count' => $total_match_members_count, 'total_match_approval_members_count' => $total_match_approval_members_count, 'total_match_pending_members_count' => $total_match_pending_members_count, 'member_additional_count' => $member_additional_count, 'member_additional_amount' => $member_additional_amount, 'member_arrear_count' => $member_arrear_count, 'member_arrear_amount' => $member_arrear_amount, 'status' => 1];
        }
        echo json_encode($json_data); 
    }
