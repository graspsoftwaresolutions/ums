          ...
          <div class="collapsible-body">
            <ul class="collapsible collapsible-sub" data-collapsible="accordion">
              ...
              @if($user_role=='company')
                 <li id="subvariance_sidebar_li_id" class=""><a id="subvariance_sidebar_sidebar_a_id" class="collapsible-body " href="{{ route('subscription.variance',app()->getLocale()) }}" data-i18n=""><i class="material-icons">radio_button_unchecked</i><span>{{ __('Variation list') }}</span></a></li>
