...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <title>User Page | Membership</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/public/assets/css/pages/page-404.css') }}">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
  ...
  <div class="row">
    ...
    <div class="col s12 center-align white">
      <img src="{{ asset('/public/assets/images/gallery/error-2.png') }}" class="bg-image-404" alt="">
      <h1 class="error-code m-0">{{ $data }}</h1>
      <h6 class="mb-2">Please contact admin</h6>
      <a class="btn waves-effect waves-light gradient-45deg-deep-purple-blue gradient-shadow mb-4" href="{{ URL::to("/") }}">Back
        TO Home</a>
          <a class="btn waves-effect waves-light red gradient-shadow mb-4" href="{{ route('logout', app()->getLocale()) }}"  onclick="event.preventDefault(); document.getElementById('logout-form').submit();"> {{__('Logout')}}</a>
