                            ...
                            <div class="card">
                                <div class="card-content">
                                   ...
                                   <div id="view-validations">
                                    <form class="formValidate" id="AppformValidate" method="post" action="{{ route('appform.store',app()->getLocale()) }}">
                                        @csrf
                                      <div class="row">
                                        ...
                                        <p>
                                        <label>
                                            <input type="checkbox" name="isactive" class="common-checkbox" id="isactive" value="1"  />
                                        ...
                                        <p>
                                        <label>
                                            <input type="checkbox" name="isinsert" class="common-checkbox" id="isinsert" value="1"  />
                                        ...
                                        <p>
                                        <label>
                                            <input type="checkbox" name="isupdate" class="common-checkbox" id="isupdate" value="1"  />
                                        ...
                                        <p>
                                        <label>
                                            <input type="checkbox" name="isdelete" class="common-checkbox" id="isdelete" value="1"  />
                                        ...
                                        <p>
                                        <label>
                                            <input type="checkbox" name="ismenu" class="common-checkbox" id="ismenu" value="1"  />
