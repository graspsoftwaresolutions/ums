...
<div class="row">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s10 m6 l6">
                                    <h5 class="breadcrumbs-title mt-0 mb-0">{{__('Upload Salary') }}</h5>
                                    <ol class="breadcrumbs mb-0">
                                        <ol class="breadcrumbs mb-0">
                                            <li class="breadcrumb-item"><a href="{{ route('home', app()->getLocale())  }}">{{__('Dashboard') }}</a>
                                            </li>
                                            <li class="breadcrumb-item active">{{__('Upload Salary') }}
                                            </li>
                                        </ol>
                                </div>
                        ...
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12 m12">
                                    ...
                                    <div class="row">
                                        <form class="formValidate" id="subscribe_formValidate" method="post" action="{{ url(app()->getLocale().'/latestsalary_update') }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col m2 s12 ">
                                                    ...
                                                    <select name="types" id="types" class="browser-default valid" aria-invalid="false">
                                                        ...
                                                        @foreach($data['inctypes'] as $type)
                                                            <option @if($type->id==1) selected @endif value="{{$type->id}}">{{$type->type_name}}</option>
                                                        @endforeach
    ...
    <script>
        ...
        $("#latestsalary_sidebar_li_id").addClass('active');
        $("#latestsalary_sidebar_a_id").addClass('active');
