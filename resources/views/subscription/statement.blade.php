			...
			<div class="card-content">
				...
				<form method="post" id="filtersubmit" action="">
					...
					<div id="hidesearch" class="row">
						<input id="member_auto_id" type="text" class="hide" class="validate " value="{{ $data['member_id'] }}" name="member_auto_id">
...
<div class="row">
	<div class="col s12">
		@php
			$searchfilters = url(app()->getLocale().'/member_statement').'?offset=0&to_date='.$data['to_date'].'&member_auto_id='.$data['member_id'];
		@endphp
