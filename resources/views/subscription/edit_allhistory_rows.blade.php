...
<div class="content-wrapper-before"></div>
    ...
    <form class="formValidate" id="addarrear_formValidate" method="post" action="{{ route('subscription.updatehistoryrows',[app()->getLocale(),2]) }}">
         @csrf
    <div class="container">
      <div class="card">
...
function AddNewHistory(){
  ...
  var history = '<tr><td> <input type="text" name="month_auto_id[]" id="month_auto_id_'+totalno+'" class="hide" value=""/><input type="text" name="entry_date[]" id="entry_date_'+totalno+'" value="" class="datepicker-custom entry_date valid" aria-invalid="false"><input id="total_months" type="text" class="validate hide" readonly="" value="0" name="total_months[]"/></td>';
