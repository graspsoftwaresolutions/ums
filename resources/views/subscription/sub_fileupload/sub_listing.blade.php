...
<div class="row">
    ...
    <div id="subsfilter" class="row">
        <div class="col s12">
            <div class="container">
                @php $auth_user = Auth::user(); $companylist = []; $companyid = ''; if(!empty($auth_user)){ $userid = Auth::user()->id; $get_roles = Auth::user()->roles; $user_role = $get_roles[0]->slug; if($user_role =='union'){ $companylist = CommonHelper::getCompanyListAll(); } else if($user_role =='union-branch'){ $unionbranchid = CommonHelper::getUnionBranchID($userid); $companylist = CommonHelper::getUnionCompanyList($unionbranchid); } else if($user_role =='company'){ $companyid = CommonHelper::getCompanyID($userid); $companylist = CommonHelper::getCompanyList($companyid); } else if($user_role =='company-branch'){ $companyid = CommonHelper::getCompanyID($userid); $companylist = CommonHelper::getCompanyList($companyid); } $company_count = count($companylist); } @endphp @if($user_role=='company')
                <!--Basic Form-->
                            ...
                            <div class="card-content">
                                ...
                                <form class="formValidate" id="subscribe_formValidate" method="post" action="{{ url(app()->getLocale().'/subscribe_download') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="col m2 s12 hide">
                                        ...
                                        <select id="type" name="type" class="error browser-default common-select add-select" onChange="return FileUploadEnable(this.value)">
                    ...
                    <div class="col s12 m6">
                        <div id="DivIdToPrint" class="card subscriber-list-card animate fadeRight">
                            ...
                            <table class="subscription-table responsive-table highlight">
                                ...
                                <tbody>
                                    @php 
	                                    $get_roles = Auth::user()->roles; $user_role = $get_roles[0]->slug; $user_id = Auth::user()->id; $total_members_count = 0; $total_members_amount = 0; $slno =1; @endphp @foreach($data['member_stat'] as $key => $stat) @php $member_sub_link = URL::to(app()->getLocale().'/subscription-status?member_status='.$stat->id.'&date='.strtotime('now')); $member_status_count = CommonHelper::statusSubsMembersNotDojCount($stat->id, $user_role, $user_id); $member_status_amount = CommonHelper::statusMembersNotDojAmount($stat->id, $user_role, $user_id); 
                                    ...
                                    @php if($hidestruckoff==''){ $total_members_count += $member_status_count; $total_members_amount += $member_status_amount; $slno++; } @endphp @endforeach @php $total_sundry_count = CommonHelper::statusSubsMatchCount(2, $user_role, $user_id); $total_sundry_amount = CommonHelper::statusSubsMatchAmount(2, $user_role, $user_id); @endphp
                                    ...
                                    @php $total_members_count += $total_sundry_count; $total_members_amount += $total_sundry_amount; @endphp
                                </tbody>
                                <tfoot>
                    ...
                    <div class="col s12 m6">
                        <div class="card subscriber-list-card animate fadeRight">
                            ...
                            <table class="subscription-table responsive-table highlight">
                                ...
                                <tbody>
                                    @php $total_match_members_count = 0; $total_match_approval_members_count = 0; $total_match_pending_members_count = 0; $slno1 = 1; @endphp @foreach($data['approval_status'] as $key => $stat) @php $match_members_count = CommonHelper::statusSubsMatchNotDojCount($stat->id, $user_role, $user_id); $match_approval_members_count = CommonHelper::statusSubsMatchNotApprovalCount($stat->id, $user_role, $user_id,1); $match_pending_members_count = CommonHelper::statusSubsMatchNotApprovalCount($stat->id, $user_role, $user_id,0); $hidestruckoffone = ''; if(($user_role=='company' || $user_role=='company-branch') && ($stat->id == 6 || $stat->id == 7)){ $hidestruckoffone = 'hide'; } @endphp
                                    ...
                                    @php if($hidestruckoffone==''){ $total_match_members_count += $match_members_count; $total_match_approval_members_count += $match_approval_members_count; $total_match_pending_members_count += $match_pending_members_count; $slno1++; } @endphp @endforeach
                                </tbody>
                                <tfoot>
                    ...
                    <div class="col s12 m6">
                        <div class="card subscriber-list-card animate fadeRight">
                            ...
                            <table class="subscription-table responsive-table highlight">
                                ...
                                <tbody>
                                    @php $get_roles = Auth::user()->roles; $user_role = $get_roles[0]->slug; $user_id = Auth::user()->id; @endphp @foreach($data['member_stat'] as $key => $stat)
                    ...
                    <div class="col s12 m6">
                        <div class="card subscriber-list-card animate fadeRight">
                            ...
                            <table class="subscription-table responsive-table highlight">
                                ...
                                <tbody>
                                    @php //isset($data['approval_status']) ? $data['approval_status'] : ""; @endphp @foreach($data['approval_status'] as $key => $stat)
