...
<form class="formValidate" id="addadvance_formValidate" method="post"
  action="{{ route('subscription.updateAdvance',app()->getLocale()) }}">
  @csrf
  <div class="container">
    <h5 class="padding-left-10">Edit Advance Entry Details <a class="btn waves-effect waves-light right" href="{{ route('subscription.advanceentry',app()->getLocale())  }}">{{__('Back') }}</a></h5>
    @php
      $data = $data['data'];
    @endphp
    <div class="row">
      <div class="input-field col s12 m6">
        ...
        <input id="nric" class="common-input"
          name="nric" readonly="" value="{{ $data->new_ic=='' ? $data->old_ic : $data->new_ic }}" type="text" data-error=".errorTxt1">
      ...
      <div class="input-field col s12 m6">
        ...
        <input id="member_number" readonly class="common-input"
          name="member_number" value="{{ $data->member_number }}" type="text" data-error=".errorTxt2">
        <input type="hidden" value="{{ $data->memberid }}" name="membercode" id="memberid">
        <input type="hidden" value="{{ $data->advanceid }}" name="advanceid" id="advanceid">
      ...
      <div class="col s12 m6">
        ...
        <input id="member_name" class="common-input"
          name="member_name" value="{{ $data->membername }}" readonly type="text" data-error=".errorTxt3">
      ...
      <div class="col s12 m6">
        ...
        <input id="company_name" class="common-input"
          name="company_name" value="{{ $data->company_name }}" readonly type="text" data-error=".errorTxt3">
      ...
      <div class="col s12 m6">
        ...
        <input id="company_branch" class="common-input"
          name="company_branch" value="{{ $data->branch_name }}" readonly type="text" data-error=".errorTxt3">
      ...
      <div class="col s12 m6">
        ...
        <input id="status" class="common-input"
          name="status" value="{{ $data->status_name }}" type="text" readonly data-error=".errorTxt3">
        <div class="errorTxt3"></div>
      ...
      <div class="col s12 m6 hide">
        ...
        <input id="advance_date"  type="text" class="datepicker" value="{{ $data->advance_date }}" name="advance_date">
        <div class="errorTxt5"></div>
      </div>
      <div class="col s12 m6">
        <label
          class="common-label  force-active">{{__('Advance Date') }}*</label>
        <input id="from_date"  type="text" value="{{ date('M/Y',strtotime($data->from_date)) }}" required class="datepicker-custom" name="from_date">
        <div class="errorTxt5"></div>
      </div>
      <div class="col s12 m6">
        <label
        ...
        <input id="no_of_months" class="common-input"
          name="no_of_months" required type="number" value="{{ $data->no_of_months }}" min="1" data-error=".errorTxt7">
      ...
      <div class="col s12 m6">
        <div class="row">
          ...
          <div class="col s12 m12">
            ...
            <input id="advance_amount" value="{{ $data->advance_amount }}" class="common-input"
