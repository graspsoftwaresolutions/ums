...
@endforeach
@endif */
function call_second_data(){
	//$('.datatable-display-1').DataTable().destroy();
	//dataTable_1.draw();
		/* $('.datatable-display-1').DataTable().empty();
	$('.datatable-display-1').DataTable().fnDestroy();
	$('.datatable-display-1').DataTable().empty(); */
	/* if(typeof dataTable_1 != 'undefined'){
		$('.datatable-display-1').DataTable().destroy();
		$('.datatable-display-1').DataTable().empty();
		dataTable_1.destroy();
		dataTable_1.empty();
	...
	/* $('.datatable-display-1').DataTable().destroy();
	$('.datatable-display-1').DataTable().clear(); */
}

function call_third_data(){
