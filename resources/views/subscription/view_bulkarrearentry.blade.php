...
<div class="content-wrapper-before"></div>
      ...
      <div class="card">
          <div class="card-title">
			<h5 class="padding-left-10">Arrear Entry Details(Bulk)
         <a style="margin-left: 10px;" onclick="AddNewHistory()" class="btn waves-effect waves-light blue right ">{{__('Add Additional Row') }}</a> &nbsp; &nbsp; <a class="btn waves-effect waves-light right" href="{{ route('subscription.arrearentry',app()->getLocale())  }}">{{__('Back') }}</a></h5>
      </div>
			<div class="row">
            ...
            <table class="bordered">
                ...
                <tbody>
                     <tr>
                        ...
                        <td>
                         {{ date('d-m-Y',strtotime($edit_data->arrear_date)) }}
                        </td>
                        <td>
                          {{$edit_data->arrear_amount}}
                        </td>
                        <!--td>
                          {{$edit_data->no_of_rows}}
                        </td-->
                    </tr>
                </tbody>
            </table>
            ...
            <table id="member_history" class="bordered">
                ...
                <tbody>
                    @php
                      $slno=0;
                    @endphp
                    @for($rowi=0;$rowi<$edit_data->no_of_rows; $rowi++)
                     <tr>
                        <td>
                            <input type="text" name="from_entry_date[]" id="from_entry_date_{{ $slno }}" value="" class="datepicker-custom entry_date" readonly="true" />
                        </td>
                          <td>
                            <input type="text" name="to_entry_date[]" id="to_entry_date_{{ $slno }}" value="" class="datepicker-custom entry_date" readonly="true" />
                        </td>
                        <td>
                ...
                <tfoot style="background: #dbdbf7;font-weight:bold;">
                   <tr>
                        ...
                        <th>
                          <input type="text" style="background: none !important;" readonly="true" name="total_bf_amount" id="total_bf_amount" value="0" class="" />
                        </th>
                         <th>
                          <input type="text" style="background: none !important;" readonly="true" name="total_insurance_amount" id="total_insurance_amount" value="0" class="" />
                        </th>
                    </tr>
                </tfoot>
            </table>
