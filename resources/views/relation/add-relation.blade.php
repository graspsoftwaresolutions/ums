                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s10 m6 l6">
                                        <h5 class="breadcrumbs-title mt-0 mb-0">Add Relation Details</h5>
                            ...
                            <div class="card">
                                <div class="card-content">
                                   ...
                                   <div id="view-validations">
                                    <form class="formValidate" id="relation_formValidate" method="post" action="{{url('relation_save')}}">
                                        @csrf
                                      <div class="row">
                                        <div class="input-field col s12 m6">
                                          <label for="relation_name">Relation Name*</label>
                                          <input id="relation_name" name="relation_name" type="text" data-error=".errorTxt1">
