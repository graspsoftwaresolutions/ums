                                ...
                                <div class="col s10 m6 l6">
                                    ...
                                    <ol class="breadcrumbs mb-0">
                                        <ol class="breadcrumbs mb-0">
                                            ...
                                            <li class="breadcrumb-item active">{{__('Upload File') }}
                                            </li>
                                        </ol>
                                </div>
                                <div class="col s2 m3 ">
                        ...
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12 m12">
                                    ...
                                    <div class="row">
                                        <form class="formValidate" id="subscribe_formValidate" method="post" action="{{ url(app()->getLocale().'/ecopark_update') }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
