...
<body>
	<div class="" style="text-align: center">
		<table width="100%">
			<tr>
				@php 
					$searchfilters = '&designation='.$data['designation'].'&company_id='.$data['company_id'].'&branch_id='.$data['branch_id'].'&unionbranch_id='.$data['unionbranch_id'];
				@endphp
				<td width="20%"></td>
				<td width="10%"></td>
				...
				<td width="20%">	
					...
					<a href="{{ url(app()->getLocale().'/export-pdf-designation?offset=0'.$searchfilters) }}" class="export-button btn btn-sm " style="background:#ff0000;"><i class="material-icons">picture_as_pdf</i></a>
    ...
    @include('reports.common_designation')
