...
<body>
	<div class="" style="text-align: center">
		<table width="100%">
			<tr>
				@php 
					$searchfilters = '&company_id='.$data['company_id'].'&branch_id='.$data['branch_id'].'&member_auto_id='.$data['member_auto_id'].'&unionbranch_id='.$data['unionbranch_id'];
				@endphp
				<td width="20%"></td>
				<td width="10%"></td>
