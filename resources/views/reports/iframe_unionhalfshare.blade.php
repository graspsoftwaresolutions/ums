...
<body>
	<div class="" style="text-align: center">
		<table width="100%">
			@php 
				$searchfilters = '&month_year='.$data['month_year'].'&unionbranch_id='.$data['unionbranch_id'];
			@endphp
			<tr>
				<td width="20%"></td>
				<td width="10%"></td>
				...
				<td width="20%">	
					...
					<a href="{{ url(app()->getLocale().'/export-pdf-half-share?offset=0'.$searchfilters) }}" class="export-button btn btn-sm hide" style="background:#ff0000;"><i class="material-icons">picture_as_pdf</i></a>
    ...
    I'm The Footer
  	...
  	@include('reports.common_unionhalf_share')
