		...
		<table width="100%">
			<tr>
				...
				<td width="20%">	
					...
					<a href="{{ url(app()->getLocale().'/export-pdf-member-transfers?offset=0'.$searchfilters) }}" class=" export-button btn btn-sm" style="background:#ff0000;"><i class="material-icons">picture_as_pdf</i></a>
