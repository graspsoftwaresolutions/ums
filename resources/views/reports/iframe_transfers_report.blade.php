...
<body>
	<div class="" style="text-align: center">
		<table width="100%">
			<tr>
				@php 
					$searchfilters = '&from_date='.$data['from_date'].'&to_date='.$data['to_date'];
				@endphp
				<td width="20%"></td>
				<td width="10%"></td>
				...
				<td width="20%">	
					...
					<a href="{{ url(app()->getLocale().'/export-pdf-branch-status?offset=0'.$searchfilters) }}" class="hide export-button btn btn-sm" style="background:#ff0000;"><i class="material-icons">picture_as_pdf</i></a>
    ...
    @include('reports.common_member_transfers')
	
	<input type="text" name="memberoffset" id="memberoffset" class="hide" value=""></input>
</body>
<script>
	var excelfilenames="Branch Transfer Report";
</script>
