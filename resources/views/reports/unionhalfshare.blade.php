            ...
            <div class="container">
                <div class="section section-data-tables">
                    ...
                    <div class="row">
                            ...
                            <div class="container">
                              <div class="row">
                                    <div class="col s10 m6 l6">
                                        <h4 class="breadcrumbs-title mt-0 mb-0"><strong>{{__('Half share Report') }}</strong></h4>
                                        <ol class="breadcrumbs mb-0">
                                            <ol class="breadcrumbs mb-0">
                                                <li class="breadcrumb-item"><a
                                                        href="{{ route('home', app()->getLocale())  }}">{{__('Dashboard') }}</a>
                                                </li>
                                                <li class="breadcrumb-item active">{{__('Reports') }}
                                                </li>
                                            </ol>
                                    </div>
								</div>
                        ...
                        <div class="col s12">
							<iframe src="{{ url(app()->getLocale().'/newhalfshare_unionreport') }}?month_year={{date('M/Y')}}&unionbranch_id=" id="myframe" height="400px" width="100%"></iframe>
                        </div>
                    </div>
                    <!-- END: Page Main-->
...
$("#halfshare_sidebar_li_id").addClass('active');
$("#halfshare_sidebar_a_id").addClass('active');
...
//$(function() {
	...
	$(document).ready(function() {
		...
		$(document).on('submit','form#filtersubmit',function(event){
			...
			if(month_year!="" && unionbranch_id!=''){
				var searchfilters = '&month_year='+month_year+'&unionbranch_id='+unionbranch_id;
			//	$("#memberoffset").val("{{$data['data_limit']}}");
				$("#myframe").contents().find("html").css('opacity',0);
				$("#myframe").attr("src", "{{ url(app()->getLocale().'/newhalfshare_unionreport') }}?offset=0"+searchfilters,);
