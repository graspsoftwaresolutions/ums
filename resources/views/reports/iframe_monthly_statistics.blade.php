...
<body>
		...
		<table width="100%">
			<tr>
				...
				<td width="20%">	
					...
					<a href="{{ url(app()->getLocale().'/export-pdf-statistics?offset=0'.$searchfilters) }} " class="export-button btn btn-sm hide" style="background:#ff0000;"><i class="material-icons">picture_as_pdf</i></a>
   ...
   @include('reports.common_monthly_statistics')
	
	<input type="text" name="memberoffset" id="memberoffset" class="hide" value="{{$data['data_limit']}}"></input>
</body>
<script>
	var excelfilenames="Monthly Statistics Report";
</script>
