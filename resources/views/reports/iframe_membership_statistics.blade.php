...
<body>
	<div class="" style="text-align: center">
		<table width="100%">
			<tr>
				...
				<td width="20%">	
					<a href="{{ url(app()->getLocale().'/export-excel-membership-statistics?offset=0'.$searchfilters) }}" class="export-button btn btn-sm" style="background:#227849;"><i class="material-icons">explicit</i></a>
    ...
    @include('reports.common_membership_statistics')
	
	<input type="text" name="memberoffset" id="memberoffset" class="hide" value=""></input>
</body>
<script>
	var excelfilenames="Yearly Statistics Report";
</script>
