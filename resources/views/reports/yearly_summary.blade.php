					...
					<div class="row">                          
						<div class="col s12 m6 l3">
							...
							<select name="from_year" id="from_year" class="error browser-default selectpicker" data-error=".errorTxt22" >
								...
								<option @if($y==$data['from_year']) selected @endif value="{{ $y }}">{{ $y }}</option>
								@endfor
							</select>
						</div>
						<div class="col s12 m6 l3">
...
<div class="row">
	<div class="col s12">
		<iframe src="{{ url(app()->getLocale().'/get-yearly-summary-report') }}?from_year={{$data['from_year']}}&to_year={{$data['to_year']}}&company_id=&branch_id=&unionbranch_id=" id="myframe" height="500px" width="100%"></iframe>
	</div>
</div>
@php	
	$ajaxcompanyid = '';
