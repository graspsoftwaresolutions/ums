...
<div class="row">
	<div class="col s12">
		...
		<div class="row">
		<div class="col s12">
			<iframe src="{{ route('reports.branchstatus',[app()->getLocale()])  }}" id="myframe" height="400px" width="100%"></iframe>
...
$("#member_status_sidebar_li_id").addClass('active');
$("#member_status_sidebar_a_id").addClass('active');
	...
	$(document).on('submit','form#filtersubmit',function(event){
		...
		if(month_year!="" || company_id!="" || branch_id!="" || member_auto_id!=""){
			...
			$("#myframe").attr("src", "{{ url(app()->getLocale().'/get-branchstatus-filter-report') }}?offset=0"+searchfilters,);
