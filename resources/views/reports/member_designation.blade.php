...
<div class="row">
	<div class="col s12">
				...
				<form method="post" id="filtersubmit" action="">
					...
					<div class="row">                          
						<div class="col s12 m6 l3">
                            ...
                            <select name="designation" id="designation" data-error=".errorTxt2" required="" class="error browser-default selectpicker" >
		...
		<div class="row">
		<div class="col s12">
			<iframe src="{{ route('reports.empty',[app()->getLocale()])  }}" id="myframe" height="400px" width="100%"></iframe>
...
$("#designation_report_sidebar_li_id").addClass('active');
$("#designation_report_sidebar_a_id").addClass('active');
	...
	$('#company_id').change(function(){
	   ...
	   if(CompanyID!='' && CompanyID!='undefined')
	   {
		...
		$('#filtersubmit').validate({
			...
			messages: {
				 designation: {
					  required: '{{__("Please Select Designation") }}',
				 }, 
				/*   company_id: {
	...
	$(document).on('submit','form#filtersubmit',function(event){
		...
		if(designation!=""){
			var searchfilters = '&designation='+designation+'&company_id='+company_id+'&branch_id='+branch_id+'&unionbranch_id='+unionbranch_id;
			
			
			$("#myframe").attr("src", "{{ url(app()->getLocale().'/get-designation-filter-report') }}?offset=0"+searchfilters,);
