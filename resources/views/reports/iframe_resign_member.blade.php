	...
	<div class="" style="text-align: center">
		...
		<table width="100%">
			...
			@php $logo = CommonHelper::getLogo(); @endphp
				...
				<td width="20%">	
					<a href="{{ url(app()->getLocale().'/export-excel-resignmembers?offset=0'.$searchfilters) }}" class="export-button btn btn-sm " style="background:#227849;"><i class="material-icons">explicit</i></a>
