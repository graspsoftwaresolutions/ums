...
<div class="row">
	<div class="col s12">
		<iframe src="{{ url(app()->getLocale().'/get-yearly-statistics-report') }}?from_year={{$data['from_year']}}&to_year={{$data['to_year']}}" id="myframe" height="450px" width="100%"></iframe>
