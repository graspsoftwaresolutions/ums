	...
	<div class="" style="text-align: center">
		<table width="100%">
			<tr>
				...
				<td width="20%">	
					<a href="{{ url(app()->getLocale().'/export-excel-resignmembers-union?offset=0'.$searchfilters) }}" class=" export-button btn btn-sm" style="background:#227849;"><i class="material-icons">explicit</i></a>
