...
<body>
	<div class="" style="text-align: center">
		<table width="100%">
			@php 
				$searchfilters = '&month_year='.$data['month_year'].'&company_id='.$data['company_id'].'&unionbranch_id='.$data['unionbranch_id'];
			@endphp
			<tr>
				...
				<td width="20%">	
					...
					<a href="{{ url(app()->getLocale().'/export-pdf-due?offset=0'.$searchfilters) }}" class="export-button btn btn-sm" style="background:#ff0000;"><i class="material-icons">picture_as_pdf</i></a>
