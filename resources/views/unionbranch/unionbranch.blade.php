												...
												<tbody>
													...
													$parameter =[
                                                     ...
                                                     <td>{{$value->is_head}}</td>
														...
														<td><a class="btn-small waves-effect waves-light cyan" href="{{url('unionbranch-edit/').'/'.$parameter}}">Edit</a> </td>
														<td><a class="btn-small waves-effect waves-light amber darken-4" href="{{url('unionbranch-delete/').'/'.$value->id}}" onclick="if (confirm('Are you sure you want to delete?')) return true; else return false;">Delete</a></td>
												  </tr>
												  @endforeach
												</tbody>
											</table>
