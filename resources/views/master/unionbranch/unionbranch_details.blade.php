                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col s10 m6 l6">
                                        ...
                                        <h5 class="breadcrumbs-title mt-0 mb-0">{{__('Edit Union Branch Details') }}</h5>
                                        @else
                                      ...
                                      <div class="row">
                                       ...
                                       <div class="input-field col s12 m6">
                                            ...
                                            <label for="postal_code" class="common-label">{{__('Postal Code') }} *</label>
                                                <input id="postal_code" name="postal_code" class="common-input" value="@isset($values){{$values->postal_code}}@endisset" type="text" data-error=".errorTxt13">
                                                <div class="errorTxt13"></div>
                                            </div>
                                            <div class="input-field col s12 m6">
                                            <label for="address_one" class="common-label">{{__('Address Line 1') }}*</label>
                                                <input id="address_one" name="address_one" class="common-input" value="@isset($values){{$values->address_one}}@endisset" type="text" data-error=".errorTxt14">
                                                <div class="errorTxt14"></div>
                                            </div>
                                            <div class="input-field col s12 m6">
                                            <label for="address_two" class="common-label">{{__('Address Line 2') }}</label>
                                                <input id="address_two" name="address_two" class="common-input" value="@isset($values){{$values->address_two}}@endisset" type="text" data-error=".errorTxt15">
                                                <div class="errorTxt15"></div>
                                            </div>
                                            <div class="input-field col s12 m6">
                                            <label for="address_three" class="common-label">{{__('Address Line 3') }}</label>
                                                <input id="address_three" name="address_three" class="common-input" value="@isset($values){{$values->address_three}}@endisset" type="text" data-error=".errorTxt15">
                                                <div class="errorTxt15"></div>
                                            </div>
                                            <div class="input-field col s12 m6">
                                                <label for="phone" class="common-label">{{__('Phone') }} *</label>
                                                <input id="phone" name="phone" type="text" class="common-input" value="@isset($values){{$values->phone}}@endisset" data-error=".errorTxt100">
                                                <div class="errorTxt100"></div>
                                            </div>
                                            <div class="input-field col s12 m6">
                                                <label for="mobile" class="common-label">{{__('Mobile Number') }} *</label>
                                                <input id="mobile" name="mobile" type="text" class="common-input" value="@isset($values){{$values->mobile}}@endisset" data-error=".errorTxt5">
                                        ...
                                        <p>
                                        <label>
                                            <input type="checkbox" name="is_head" class="common-checkbox" id="is_head" value="1" @isset($values) {{ $values->is_head == '1' ? 'checked' : '' }} @endisset />
                                            <span>{{__('Head') }}</span>
                                        </label>
                                        </p>
                                        <div class="clearfix" style="clear:both"></div>
