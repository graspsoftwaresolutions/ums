                            ...
                            <div class="card">
                                <div class="card-content">
                                   ...
                                   <div id="view-validations">
                                    <form class="formValidate" id="RolesformValidate" method="post" action="{{ route('roles.update',[app()->getLocale(),$data['roles_edit']->id]) }}">
                                    <?php $row = $data['roles_edit'][0]; ?>
                                        @method('PATCH')
                                        @csrf
                                      <div class="row">
                                        <div class="input-field col s12 m6">
                                          <label for="name" class="common-label">{{__('Role Name') }}*</label>
                                          <input id="name" class="common-input" value="<?php echo $data['roles_edit']->name; ?>" name="name" type="text" data-error=".errorTxt1">
                                          <div class="errorTxt1"></div>
                                        </div>
                                        <div class="input-field col s12 m6">
                                          <label for="slug" class="common-label">{{__('Slug') }}*</label>
                                          <input id="slug" class="common-input" value="<?php echo $data['roles_edit']->slug; ?>" name="slug" type="text" data-error=".errorTxt2">
