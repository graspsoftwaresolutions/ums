							...
							<div class="container">
								<div class="row">
									<div class="col s10 m6 l6">
										<h5 class="breadcrumbs-title mt-0 mb-0">Race List</h5>
						...
						<div class="col s12">
							<div class="card">
								<div class="card-content">
									<h4 class="card-title">Race List</h4>
                           ...
                           @foreach($data['race_view'] as $key=>$value)
                            ...
                            $parameter = Crypt::encrypt($parameter);    
													 ?>
														...
														<a class="btn-small waves-effect waves-light cyan" href="{{url('race-edit/').'/'.$parameter}}">Edit</a>
														<a class="btn-small waves-effect waves-light amber darken-4" href="{{url('race-delete/').'/'.$value->id}}" onclick="if (confirm('Are you sure you want to delete?')) return true; else return false;">Delete</a></td>
												  </tr>
												  @endforeach
												</tbody>
