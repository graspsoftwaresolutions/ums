									...
									<div class="card theme-mda">
										<div class="card-content pb-0">
											...
											@csrf
													...
													<div class="col-sm-8 col-sm-offset-1">
														<div class="row">
															<div id="moredata" class="hide">
																		...
																		<div class=""> {{__('Nominee Details') }}</div>
																		<div class="">
																		...
																		<div class="">{{__('Guardian Details') }}</div>
																		<div class="">
																			<div class="row">
																				<div class="input-field col s12 m4">
												...
												<br>
												<br>
											 	<div class="input-field col s12" style="position: fixed;left: 0;bottom: 0; width: 100%;background-color: #6a72cc;color: white;text-align: center; padding: 10px;">
