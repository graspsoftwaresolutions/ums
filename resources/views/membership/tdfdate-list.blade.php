...
<div class="row">
  <div class="col s10 m6 l6">
      ...
      <ol class="breadcrumbs mb-0">
          <li class="breadcrumb-item"><a href="">{{__('TDF List') }}</a>
          </li>
          <li class="breadcrumb-item active">{{__('TDF List') }}
          </li>
          </li>
      </ol>
  </div>
                      ...
                      <div class="col s12">
                          <div class="card">
                              <div class="card-content">
                                  <h4 class="card-title">{{__('TDF List') }}</h4>
                                  ...
                                  <div class="row">
                                      <div class="col s12">
                                          <table id="page-length-option" class="display">
                                              ...
                                              <tbody>
                                                @foreach($data['tdfdates'] as $tdfdate)
                                                 <tr>
                                                   <td>{{ date('Y',strtotime($tdfdate)) }}</td>
                                                   <td>{{ CommonHelper::TDFMembersCount($tdfdate) }}</td>
                                                   <td>{{ number_format(CommonHelper::TDFMembersAmount($tdfdate),2,".",",") }}</td>
                                                   <td>
                                                    <a class="mb6 btn btn-sm waves-light purple lightrn-1" href="{{ route('tdf.summary', [app()->getLocale()]) }}?date={{ strtotime($tdfdate) }}">Summary</a>
                                                     <a class="mb6 btn btn-sm waves-light orange lightrn-1" href="{{ route('tdf.members', [app()->getLocale()]) }}?date={{ strtotime($tdfdate) }}">View Members</a>
                                                   </td>
                                                 </tr>
                                                @endforeach
                                              </tbody>
